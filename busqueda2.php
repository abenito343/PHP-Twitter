...
<div id="background">
  ...
  <table width="716" height="470" border="0" cellspacing="5">
    <tr>
      <th width="388" height="65" scope="col"><p>&nbsp;
...
while ($registro=mysql_fetch_array($consulta)){?>
	<tr>
		...
		<?php echo "<td bgcolor=#FF0000><a href=favoriteador.php?user_id=".$_COOKIE['UID']."&id=".$registro[0]."&favoritos=".$registro[4].">Dejar de seguir</a>"; ?>
